...
diretorio_raiz = r'C:\Users\Asafe\OneDrive - ifsp.edu.br\Documentos\Asafe IFSP\TCC\programação\storage_repo\dados_exames\Patients_xlsx_microvoltz'
diretorio_PNES = r'C:\Users\Asafe\OneDrive - ifsp.edu.br\Documentos\Asafe IFSP\TCC\programação\storage_repo\dados_exames\Patients_xlsx_microvoltz\PNES'
diretorio_SE = r'C:\Users\Asafe\OneDrive - ifsp.edu.br\Documentos\Asafe IFSP\TCC\programação\storage_repo\dados_exames\Patients_xlsx_microvoltz\SE'
diretorio_save = r'C:\Users\Asafe\OneDrive - ifsp.edu.br\Documentos\Asafe IFSP\TCC\programação\storage_repo\dados_exames\Dataset'
...
dataset.to_excel(os.path.join(
    diretorio_save, 'dataset_continus_microvoltz.xlsx'))
